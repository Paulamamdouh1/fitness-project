...
import styles from "./Shoulder.module.css";
import ground from "../assets/images/ground.jpg";
import img1 from "../assets/images/Arm-Circles_Shoulders.gif";
import img2 from "../assets/images/Dumbbell-Lateral-Raise.gif";
import img3 from "../assets/images/Dumbbell-Push-Press.gif";
import img4 from "../assets/images/Dumbbell-Shoulder-Press.gif";
import img5 from "../assets/images/Smith-Machine-Shoulder-Press.gif";
...
async function gettrapsExercises(){ 
let {data} = await axios.get("https://api.api-ninjas.com/v1/exercises?muscle=traps",
  {
    headers: {
  ...
  return <>
        ...
        <div className="row d-flex ">
          <div className={styles.ground}>
            ...
            <h1 className="font text-white">Shoulder 

              <span className='text-danger font'>Workouts</span>
            </h1>
        <span className="text-white">HOME /</span> 
        <span className="text-danger ">Shoulder </span>
          </div>
          </div>
        </div>
      </div>
...
{trapsExercises.slice(0,5).map((Exercise, index) => (
