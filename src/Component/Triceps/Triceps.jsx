...
import img1 from "../assets/images/triceps-Kickback.gif";
import img2 from "../assets/images/Triceps-Dips.gif";
import img3 from "../assets/images/Triceps-Extension.gif";
import img4 from "../assets/images/One-Arm Triceps.gif";
import img5 from "../assets/images/Overhand-Triceps-Dip.gif";
...
async function gettricepsExercises(){ 
let {data} = await axios.get("https://api.api-ninjas.com/v1/exercises?muscle=triceps",
  {
    headers: {
  ...
  return <>
        ...
        <div className="row d-flex ">
          <div className={styles.ground}>
            ...
            <h1 className="font text-white">Triceps 

              <span className='text-danger font'>Workouts</span>
            </h1>
        <span className="text-white">HOME /</span> 
        <span className="text-danger ">Triceps </span>
          </div>
          </div>
        </div>
      </div>
...
{tricepsExercises.slice(0,5).map((Exercise, index) => (
